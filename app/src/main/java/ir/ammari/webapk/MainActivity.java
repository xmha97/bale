...
public class MainActivity extends Activity {
    ...
    private String TAG ="WebAPK";
    private String urlToLoad = "https://ammari.ir/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GithubStar.shouldShowStarDialog(this)) GithubStar.starDialog(this,"https://github.com/xmha97/webapk");
    }
